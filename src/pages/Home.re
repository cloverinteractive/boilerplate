...
let make = () => {
  /* temporary mock */
  let (_, dispatch) = MessageContext.useMessages();
    ...
    <div className="container is-fluid">
          ...
          {librariesList
           ->Belt.List.map(
               ...
               <li key=library>
                 ...
                 " - "->React.string
                 <span className="is-italic"> description->React.string </span>
               </li>
             })
           ->Array.of_list
           ->React.array}
      ...
      <article className="content">
        ...
        <p>
          ...
          ", "->React.string
          <span className=highlightClass> "<Error500 />"->React.string </span>
          " and "->React.string
          <span className=highlightClass> "<Error404 />"->React.string </span>
        </p>
        <p>
          "We've organized the application in a simple structure making it easy to find
          everyting in the project;"
          ->React.string
        </p>
        <p>
